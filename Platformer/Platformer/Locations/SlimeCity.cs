...
namespace Platformer.Locations
{
    class SlimeCity : Location
    {
        ...
        {
            portals.Add(new Portal(2, 26, Game1.testArea, 27, 18));

            portals.Add(new Portal(15, 24, this, 6, 24));
            portals.Add(new Portal(6, 24, this, 15, 24));
            portals.Add(new Portal(25, 26, Game1.slimeHut, 1, 13));

            portals.Add(new Portal(45, 26, Game1.testTileLocation, 14, 3));
		}
    }
}